...
\begin{frame}{Experimental Results: Dataset Properties}
    ...
    \begin{tabular}{|l|l|r|r|c|}
        \hline
        \textbf{Dataset} & \textbf{Type} & \textbf{Trans.} & \textbf{Items} & \textbf{Avg. Width} \\ \hline
        c20d10k          & Synthetic     & 10,000          & 192            & 20                  \\ \hline
        chess            & Real-life     & 3,196           & 75             & 37                  \\ \hline
        mushroom         & Real-life     & 8,124           & 119            & 23                  \\ \hline
        BMS\_WebView\_1  & Real-life     & 59,602          & 497            & 2.5                 \\ \hline
        BMS\_WebView\_2  & Real-life     & 77,512          & 3,340          & 5                   \\ \hline
        T10I4D100K       & Synthetic     & 100,000         & 870            & 10                  \\ \hline
        T40I10D100K      & Synthetic     & 100,000         & 1,000          & 40                  \\ \hline
    \end{tabular}
    \vfill
    \begin{alertblock}{Dataset Diversity}
        \scriptsize The selection spans from sparse transaction logs to dense datasets, allowing for a robust evaluation of the HTT architecture across different data characteristics.
    \end{alertblock}
\end{frame}
...
\begin{frame}{Experimental Results: Summary Table}
    ...
    \begin{tabular}{|l|c|c|c|}
        ...
        BMS\_WebView\_1/2 & 1.0x                & \textbf{> 8.0x} & \textbf{> 8.4x} \\ \hline
        T10I4D100K       & 1.0x                & 5.9x            & \textbf{6.2x}   \\ \hline
        T40I10D100K      & 1.0x                & 5.8x            & \textbf{6.1x}   \\ \hline
        Mushroom / Chess & 1.0x                & 1.9x            & \textbf{2.1x}   \\ \hline
        c20d10k          & 1.0x                & 1.7x            & \textbf{1.8x}   \\ \hline
    \end{tabular}
    \vfill
