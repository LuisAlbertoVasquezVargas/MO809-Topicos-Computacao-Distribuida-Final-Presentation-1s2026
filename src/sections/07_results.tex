  ...
  \begin{columns}[onlytextwidth, T]
    \column{0.6\textwidth}
      \begin{itemize}
        ...
        \begin{itemize}
          \item \textbf{CPU:} Intel Xenon CPU E5-2620@2.10 GHz with 24 cores \textit{(Dual-Processor setup)}.
...
% --- Slide 3: Table 1 (Full Dataset Properties) ---
\begin{frame}{Experimental Results: Dataset Properties}
    \centering
    \scriptsize
    \textbf{Table 1: Datasets used in the experiments}
    \vspace{0.2cm}
    \begin{tabular}{|l|r|r|c|c|}
        \hline
        \textbf{Dataset} & \textbf{Transactions} & \textbf{Items} & \textbf{Avg. Width} & \textbf{Characteristic} \\ \hline
        c20d10k          & 10,000                & 192            & 20                  & Dense          \\ \hline
        chess            & 3,196                 & 75             & 37                  & Extremely Dense \\ \hline
        mushroom         & 8,124                 & 119            & 23                  & Dense          \\ \hline
        BMS\_WebView\_1  & 59,602                & 497            & 2.5                 & Sparse         \\ \hline
        BMS\_WebView\_2  & 77,512                & 3,340          & 5                   & Sparse         \\ \hline
        T10I4D100K       & 100,000               & 870            & 10                  & Sparse         \\ \hline
        T40I10D100K      & 100,000               & 1,000          & 40                  & Dense          \\ \hline
    \end{tabular}
    \vfill
    \begin{alertblock}{Dataset Diversity}
        \scriptsize The benchmark selection spans from sparse transaction logs to dense datasets, allowing for a robust evaluation of the HTT architecture across different data characteristics.
    \end{alertblock}
\end{frame}

% --- Slide 4: Performance I (2x2 Plot) ---
...
% --- Slide 5: Performance II (Triangular Plot) ---
\begin{frame}{Performance Analysis: Datasets (e) to (g)}
    ...
    \vspace{-0.3cm}
    \begin{itemize}
        \item \footnotesize \textbf{Observation:} For sparse datasets (BMS/T10), the Trie-based architecture achieves a significant \textbf{8x performance gain}.
    \end{itemize}
\end{frame}
...
\begin{frame}{Experimental Results: Summary Table}
    ...
    \begin{beamercolorbox}[sep=6pt,center,rounded=true]{block body}
        \textbf{Relative Speedup vs. Hash Tree (HT) Baseline}
    \end{beamercolorbox}
    \vspace{0.1cm}
    \small
    \begin{tabular}{|l|c|c|c|c|}
        \hline
        \textbf{Dataset} & \textbf{HT} & \textbf{Trie} & \textbf{HTT} & \textbf{Characteristic} \\ \hline
        c20d10k          & 1.0x        & 1.7x          & \textbf{1.8x} & Dense         \\ \hline
        chess            & 1.0x        & 1.9x          & \textbf{2.1x} & E. Dense      \\ \hline
        mushroom         & 1.0x        & 1.9x          & \textbf{2.1x} & Dense         \\ \hline
        BMS\_WebView\_1  & 1.0x        & 8.1x          & \textbf{8.4x} & Sparse        \\ \hline
        BMS\_WebView\_2  & 1.0x        & 8.1x          & \textbf{8.4x} & Sparse        \\ \hline
        T10I4D100K       & 1.0x        & 5.9x          & \textbf{6.2x} & Sparse        \\ \hline
        T40I10D100K      & 1.0x        & 5.8x          & \textbf{6.1x} & Dense         \\ \hline
    \end{tabular}
    \vfill
