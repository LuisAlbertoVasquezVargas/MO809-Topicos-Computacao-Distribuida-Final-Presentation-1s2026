...
% --- Slide 1: The FIM Landscape (The Rollback Version) ---
...
% --- Slide 4: Specialized Data Structure Innovations ---
        ...
        \begin{column}{0.48\textwidth}
            \begin{alertblock}{Pointer-Based (Legacy)}
                ...
                \begin{tikzpicture}[scale=0.6]
                    \node[circle,draw,inner sep=1pt] (a) at (0,0) {};
                    \node[circle,draw,inner sep=1pt] (b) at (-0.8,-0.8) {};
                    \node[circle,draw,inner sep=1pt] (c) at (0.8,-0.8) {};
                    \draw[->,red,thick] (a) -- (b); \draw[->,red,thick] (a) -- (c);
                    \node[red, font=\tiny] at (0.8,-0.2) {Stall!};
                \end{tikzpicture}\\
        ...
        \begin{column}{0.48\textwidth}
            \begin{alertblock}{Direct Access (Proposed)}
                ...
                \begin{tikzpicture}[scale=0.6]
                    ...
                    \draw[->,blue,thick] (0.5,0.6) -- (0.5,0.1);
                    \node[blue, font=\tiny] at (1.2,0.5) {$O(1)$ Jump};
                \end{tikzpicture}\\
                Cache-Friendly
            \end{alertblock}
        \end{column}
